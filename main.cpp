...
int main() {
    try {
        std::cout << "Inamicii se spawneaza - elimina-i efectuand un slice" << std::endl;
        std::cout << "Apasa o litera sau cifra pentru a te teleporta + slice" << std::endl;
        ...
        std::cout << "Entitati active total: " << EntitateJoc::getContor() << std::endl;
